...
-- Taken from repository  https://github.com/nearform/temporal_tables
  ...
  IF TG_OP = 'UPDATE' OR TG_OP = 'DELETE' THEN
    ...
    IF NOT EXISTS (
        ...
        FROM
          pg_attribute
        WHERE
          attrelid = history_table::regclass AND attname = sys_period AND NOT attisdropped) THEN
...
SELECT
  history.attname AS history_name, main.attname AS main_name, history.atttypid AS history_type, main.atttypid AS main_type INTO holder
FROM
  history
